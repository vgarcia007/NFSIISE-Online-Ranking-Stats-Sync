...
def upload_files(start_dir, config_file):
    ...
    stf_files = [f for f in os.listdir(start_dir) if f.lower().endswith('.stf')]
...
if __name__ == "__main__":
    ...
    start_dir = os.path.join(dir_path, 'FEDATA', 'PC', 'STATS')
    config_file = os.path.join(dir_path, 'FEDATA', 'PC', 'CONFIG', 'config.dat')
